...
export const DeliveryForm = ({ onSuccess, onCancel }: DeliveryFormProps) => {
  ...
  const onSubmit = async (data: DeliveryFormData) => {
    try {
      setLoading(true);
      await operationsAPI.createDelivery(data);
      onSuccess();
    } catch (error: any) {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
        ...
        <button
          type="submit"
          disabled={loading}
          className="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg hover:from-purple-700 hover:to-purple-800 disabled:opacity-50 font-medium shadow-sm transition-all"
        >
